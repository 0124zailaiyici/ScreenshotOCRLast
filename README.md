...
- **用户主控复制**：废弃自动复制，提供“全部复制”与“选择复制”按钮，支持**撤销复制**。
- **系统集成**：常驻系统托盘，支持配置持久化。
...
- **撤销逻辑**：点击“撤销复制”可清空剪贴板内容（防隐私泄漏或误操作）。
...
- **\[Refactor]** 重构复制逻辑，废弃自动复制，改为“全部复制/选择复制"双模式。
- **\[Feature]** 增加复制状态提示与撤销复制功能。
